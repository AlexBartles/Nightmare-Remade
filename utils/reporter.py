...
class Main:
    def __init__(self):
        ...
        if REASON.upper() in ('1', 'ILLEGAL CONTENT'):
            ...
            os.system(
                'title [Nightmare-Remade Paid Reporter] - Restart required &&'
                'pause >NUL &&'
                'title [Nightmare-Remade Paid Reporter] - Exiting...'
            )
            time.sleep(3)
            os._exit(0)
...
if __name__ == '__main__':
    os.system('cls && title [Nightmare-Remade Paid Reporter] By AlexBartles - Main Menu')
